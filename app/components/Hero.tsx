    ...
    return(
        ...
        style={{
            ...
            <div className="bg-[#FFF3E3] flex gap-[46px] flex-col h-full md:h-fit w-fit md:mr-[58px] rounded-[10px] pl-[39px] pr-[43px] pt-[62px] pb-[37px]">
                <div>
                    <h3 className="text-[#333333] text-[22px] font-semibold">New Arrival</h3>
                    <h2 className="text-amber-600 text-primary text-[41px] md:text-[52px] font-bold leading-[50px] md:leading-[65px] mb-[17px]">Discover Our <br />New Collection</h2>
